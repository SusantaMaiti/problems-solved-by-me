...
function sorting(){
    let clothessorting= document.getElementById("clothessorting").value;

    if(clothessorting=="default"){
        catchApi()

    }    
    if(clothessorting=="LHsort"){
        data.sort((a,b)=>{
...
document.getElementById("clothessorting").addEventListener("change", sorting)




const Addtocarthandle= (el)=>{

//     let cartdata= data.filter(function(element){
...
//         }
    ...
    //if flag true data already present in cart
    if(flag){
...
function displayTable(apiData){
    let clothescontainer= document.getElementById("clothescontent")
    clothescontainer.innerHTML= null;
